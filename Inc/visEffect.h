...
void visInit();
uint8_t generate_RGB(float32_t * input_array_fft,
		float32_t * input_array_magnitude, float32_t* input_array_decibel,
		uint32_t number_of_leds, float32_t weighting);
